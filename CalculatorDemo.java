	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			while (mtpMatcher.find()) {
				...
				INPUT = INPUT.replace(mtpMatcher.group(),
								Calculator.mtp(firstNum,secondNum).toString());
			...
			while (divMatcher.find()) {
				...
				INPUT = INPUT.replace(divMatcher.group(),
								Calculator.div(firstNum,secondNum).toString());
			...
			while (addMatcher.find()) {
				...
				INPUT = INPUT.replace(addMatcher.group(),
								Calculator.add(firstNum,secondNum).toString());
			...
			while (minusMatcher.find()) {
				...
				INPUT = INPUT.replace(minusMatcher.group(),
								Calculator.sub(firstNum,secondNum).toString());
